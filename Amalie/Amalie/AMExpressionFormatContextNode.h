 ...
 */
@interface AMExpressionFormatContextNode : NSObject
...
@property (weak,readonly) AMExpressionFormatContextNode * parent;
@property (readonly) AMExpressionFormatContextNode * leftChild;
@property (readonly) AMExpressionFormatContextNode * rightChild;
